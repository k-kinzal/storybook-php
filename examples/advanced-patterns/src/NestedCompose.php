...
/**
 * Demonstrates 3-level deep object composition with typed constructor params.
 * Tests recursive instantiation: NestedCompose takes Address, Address takes Country.
 * All classes defined in the same file for runner resolution.
 */
...
class NestedCompose {
    ...
    public function render(): string {
        ...
        $phoneHtml = $this->phone !== ''
            ...
            : '';
        return <<<HTML
        <div class="nested-compose" style="padding: 16px; border: 1px solid #e5e7eb; border-radius: 10px; font-family: system-ui; max-width: 350px;">
