...
export const Passing: Story = {
  args: { name: 'Email Validator', variant: 'info', rule: 'format', value: 'user@example.com', passed: true },
};

export const Failing: Story = {
  args: { name: 'Password Validator', variant: 'danger', rule: 'min-length', value: '***', passed: false },
};
