...
export const Light: Story = {
  args: { title: 'Heredoc Syntax', body: 'This card uses PHP heredoc strings for template rendering.' },
};
...
export const WithImage: Story = {
  args: { title: 'Featured Post', body: 'A card with an image header.', imageUrl: 'https://picsum.photos/400/200' },
};
