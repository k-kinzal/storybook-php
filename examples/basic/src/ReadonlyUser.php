...
/**
 * PHP 8.2 readonly class: all promoted properties are automatically readonly.
 * Demonstrates immutable data transfer objects rendered as UI cards.
 */
readonly class ReadonlyUser {
    ...
    public function render(): string {
        ...
        return <<<HTML
        <div class="user-card" style="display: flex; align-items: center; gap: 16px; padding: 16px; border: 1px solid #e5e7eb; border-radius: 12px; font-family: system-ui;">
