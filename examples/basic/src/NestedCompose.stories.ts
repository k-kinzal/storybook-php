...
import { NestedCompose } from './NestedCompose.php@render';

const meta: Meta<typeof NestedCompose> = {
  component: NestedCompose,
  title: 'Patterns/NestedComposition',
  argTypes: {
    name: { control: 'text' },
    phone: { control: 'text' },
  },
...
export default meta;
type Story = StoryObj<typeof NestedCompose>;
