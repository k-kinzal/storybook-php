...
/**
 * Int-backed enum with methods that operate on the integer value.
 * Demonstrates that the runner correctly resolves int-backed enum
 * cases and methods can compute based on the backing integer.
 */
enum HttpPort: int {
    case Http = 80;
    case Https = 443;
