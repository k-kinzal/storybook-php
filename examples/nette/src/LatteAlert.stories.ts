...
import { LatteAlert } from "./LatteAlert.php@render";

const meta: Meta<typeof LatteAlert> = {
  component: LatteAlert,
  title: "Nette/LatteAlert",
  argTypes: {
...
export default meta;
type Story = StoryObj<typeof LatteAlert>;
