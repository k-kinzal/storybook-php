...
import { TwigCard } from "./TwigCard.php@render";

const meta: Meta<typeof TwigCard> = {
  component: TwigCard,
  title: "Symfony/TwigCard",
  argTypes: {
...
export default meta;
type Story = StoryObj<typeof TwigCard>;

export const Default: Story = {
  args: { title: "Card Title", body: "Rendered via Twig template engine." },
};
