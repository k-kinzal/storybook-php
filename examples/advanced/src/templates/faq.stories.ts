...
export const Default: Story = {
  args: {
    ...
    items: [
      {
        question: "What is storybook-php?",
        answer: "A Storybook framework addon for PHP components.",
      },
      {
        question: "Does it support enums?",
        answer: "Yes, both backed and unit enums are fully supported.",
      },
      {
        question: "Can I use templates?",
        answer: "Absolutely. Plain PHP templates work as default imports.",
      },
    ],
  },
};
