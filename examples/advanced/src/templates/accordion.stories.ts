...
export const Default: Story = {
  args: {
    items: [
      ...
      {
        title: "Does it work with PHP?",
        content: "Yes! storybook-php enables PHP component development with Storybook.",
      },
      {
        title: "How do I get started?",
        content: "Install the package and configure your Storybook to use the PHP framework.",
        open: true,
      },
    ],
  },
