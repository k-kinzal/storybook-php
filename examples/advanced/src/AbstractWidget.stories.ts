...
export const Primary: Story = {
  args: { title: 'Update Available', message: 'A new version is ready to install.', variant: 'primary' },
};

export const Success: Story = {
  args: { title: 'Saved', message: 'Your changes have been saved successfully.', variant: 'success' },
};
