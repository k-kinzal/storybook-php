...
export const WithTitle: Story = {
  args: { message: 'Please check your input and try again.', title: 'Validation Error', type: 'error' },
};
...
export const FullFeatured: Story = {
  args: { message: 'A new version is available.', title: 'Update Available', icon: '🔄', action: 'Update Now', type: 'info' },
};
