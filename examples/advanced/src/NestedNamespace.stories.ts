...
export const Required: Story = {
  args: { name: 'password', label: 'Password', type: 'password', required: true, helpText: 'Must be at least 8 characters' },
};

export const WithHelp: Story = {
  args: { name: 'website', label: 'Website', type: 'url', placeholder: 'https://', helpText: 'Enter the full URL including https://' },
};
