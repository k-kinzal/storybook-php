...
final readonly class Point {
    ...
    public function render(): string {
        ...
        return <<<HTML
        <div style="display: inline-flex; align-items: center; gap: 4px; padding: 6px 12px; background: #f0fdf4; border: 1px solid #86efac; border-radius: 6px; font-family: system-ui; font-size: 13px;">
