...
export const Default: Story = {
  args: { variant: 'default', title: 'Panel Title', content: 'Rendered using match expression dispatch.' },
};
...
export const Banner: Story = {
  args: { variant: 'banner', title: 'Announcement', content: 'Gradient banner for important messages.' },
};
